...
struct qt_meta_stringdata_HelpButton_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_HelpButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HelpButton_t qt_meta_stringdata_HelpButton = {
    {
QT_MOC_LITERAL(0, 0, 10) // "HelpButton"
...
QT_INIT_METAOBJECT const QMetaObject HelpButton::staticMetaObject = { {
    QMetaObject::SuperData::link<Button::staticMetaObject>(),
    qt_meta_stringdata_HelpButton.data,
    qt_meta_data_HelpButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *HelpButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HelpButton.stringdata0))
