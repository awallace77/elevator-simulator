...
struct qt_meta_stringdata_Speaker_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Speaker_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Speaker_t qt_meta_stringdata_Speaker = {
    {
QT_MOC_LITERAL(0, 0, 7) // "Speaker"
...
QT_INIT_METAOBJECT const QMetaObject Speaker::staticMetaObject = { {
    QMetaObject::SuperData::link<SimulationComponent::staticMetaObject>(),
    qt_meta_stringdata_Speaker.data,
    qt_meta_data_Speaker,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Speaker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Speaker.stringdata0))
